...
function buildDashboardPrompt({
  ...
  return [
    ...
    "- 우선 판단할 핵심 포인트는 다음과 같다: 1위사 독주 여부, 상위 3개사·5개사 집중도, 1~3위 간 격차, 2~5위 접전 여부, 급등·급락 회사 존재, 최근 3개월 연속 확대 여부, 나머지 회사가 한 자릿수 점유율인지 여부",
    "- 제목은 아래 패턴 중 데이터에 맞는 것을 선택해 사용할 것",
    `  1. "{GA명} {월} {시장구분} M/S…{1위사} {1위 점유율}% 1위, {2위사}·{3위사} 뒤이어"`,
    `  2. "{GA명} {월} {시장구분} M/S…{1위사} 선두 유지, {상승 회사} 순위 상승·상위권 재편"`,
    `  3. "{GA명} {월} {시장구분} M/S…'{1위사}' 1위 유지 속, '{2위사}·{3위사}' 상위권 형성"`,
    `  4. "{GA명} {월} {시장구분} M/S…상위 3개사 점유율 {합산 점유율}%, {1위사}·{2위사}·{3위사} 각축"`,
    `  5. "{GA명} {월} {시장구분} M/S…상위 5개사 {합산 점유율}% 집중, {1위사} 1위 유지"`,
    `  6. "{GA명} {월} {시장구분} M/S…{1위사} {1위 점유율}%, 이하 모두 한 자릿수"`,
    `  7. "{GA명} {월} {시장구분} M/S…{1위사} 선두, {2위사}·{3위사}·{4위사} 접전"`,
    `  8. "{GA명} {월} {시장구분} M/S…3개월 연속 비중 키운 {1위사} {1위 점유율}% 1위, {2위사}·{3위사} 순"`,
    ...
    "[마지막 문단 규칙]",
    "- 마지막 문단은 2문장 정도로 마무리",
    "- 첫 문장은 '직전 1년 누적으로는 ...' 형태로 시작해 직전 1년 기준 상위권 구조를 설명",
    "- 직전 1년 기준은 상위 집중형이면 3위까지, 분산형이면 5위까지 M/S를 나열",
    "- '최근 12개월 누적 실적은 ...' 같은 문장 대신, '직전 1년 누적으로는 교보생명 14.7%, ABL생명 14.5%, 한화생명 11.5%, 삼성생명 9.5%, NH농협생명 6.2%로 상위권 구조를 형성돼있었다.'처럼 구조 중심 문장으로 정리",
